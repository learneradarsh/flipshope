				...
				<ul class="expander-list">				
					<li>
						<span class="name">
							...
							<a href="index.php"><img src="" class="img-responsive" width="" height="" /></a>
						</span>
						<ul class="dropdown-menu megamenu image-links-layout" role="menu">												
							<li class="col-one-fourth">
								<span class="image-link">
								<a href="index.php">
								<span class="figure"><span class="btn btn--ys btn--lg">LAUNCH</span></span>
					...
					<li>
						<span class="name">
							<span class="expander">-</span>
							<a href="http://flipshope.com/blog/"><span class="act-underline">BLOG</span></a>
						</span>
						<ul class="dropdown-menu megamenu image-links" role="menu">							
							<li class="col-one-third">
								<span class="image-link">
